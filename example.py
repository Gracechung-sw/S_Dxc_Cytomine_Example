...
import cytomine
from cytomine.models import ImageInstance, ImageInstanceCollection, JobData, Property, Annotation, AnnotationTerm, AnnotationCollection
...
def main(argv):
    with cytomine.CytomineJob.from_cli(argv) as cyto_job:
        ...
        try:
            ...
            for (i, image) in enumerate(images):
                ...
                job.update(progress=progress, statusComment=f"progress: {progress} - Analyzing image id {image_id}, {image_str}...")
